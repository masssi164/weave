...
class BoardProviderPreviewCapabilities {
  ...
  const BoardProviderPreviewCapabilities.staticPreview()
    : provider = 'none',
      ...
      supportSafeSummary =
          'Static provider-neutral preview; no backend provider runtime is connected.';
  ...
  const BoardProviderPreviewCapabilities.blocked()
    : provider = 'unavailable',
      ...
      supportSafeSummary =
          'Backend Boards preview runtime is disabled or unavailable.';
...
class BoardPreview {
  const BoardPreview({
    ...
    this.releaseStatus = 'active-feature-gated-preview',
