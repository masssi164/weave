...
public class MatrixRevokedSessionEntity {
  ...
  protected MatrixRevokedSessionEntity() {}

  public MatrixRevokedSessionEntity(String sessionHash, Instant revokedAt, Instant expiresAt) {
