...
public class ProvisioningIntentEntity {
  ...
  @Column(name = "requested_capabilities", nullable = false, length = Integer.MAX_VALUE)
  ...
  protected ProvisioningIntentEntity() {}

  public ProvisioningIntentEntity(
      UUID intentId,
      String tenantId,
