...
class RuntimeStateGenerationJpaEntity {
    ...
    PersistedRuntimeStateGeneration stored() {
        return new PersistedRuntimeStateGeneration(
                generationRef,
...
class RuntimeStateDeletionJpaEntity {
    ...
    PersistedRuntimeStateDeletion deletion() {
        return new PersistedRuntimeStateDeletion(
                cellRef,
                runtimeStateStoreRef);
    }
}
...
record PersistedRuntimeStateGeneration(
        String generationRef,
        String runtimeStateStoreRef,
        long generation,
        long previousGeneration,
...
record PersistedRuntimeStateDeletion(
        String cellRef,
        String runtimeStateStoreRef) {
}
