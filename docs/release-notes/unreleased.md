...
- Makes the dedicated Live Stack E2E runner self-maintaining by removing stale Weave build outputs before its 6 GiB headroom gate, trusting the generated CA through a temporary keychain for Rust TLS, and scrubbing current generated outputs only after support-safe acceptance evidence is uploaded.
