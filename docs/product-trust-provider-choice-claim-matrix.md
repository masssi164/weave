...
| Weave Control bootstrap-to-client boundary | "Weave Control separates deploy-new, attach-existing, and hybrid admin setup from the normal member app entry." | Contract docs + client architecture tests + future E2E evidence | `docs/weave-control-bootstrap-to-client-contract.md`, first-use/provider-boundary docs, and client architecture guards. | Contract-only until #665 local Forgejo deployed-stack evidence and the #762 successor blocker for the #591 manual AT decision is complete; do not claim production mutation, full deploy/attach completion, or default Weaver PA availability. |
