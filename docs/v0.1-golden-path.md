...
| Calendar, boards/tasks, meetings, decisions | Release-scope surfaces with capability gates; user-visible behavior must stay available, disabled by policy, not configured, degraded, unavailable, coming later, or hidden according to evidence | `docs/release-v0.1-dogfood-plan.md`, `e2e/scenario_mappings.json` |
