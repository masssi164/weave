...
| Governed Weaver runtime | Guarded and dark; workload-only MCP remains unavailable until ARC proves per-cell Keycloak identity, RuntimeProfile v2 binding, approval, action evidence, rotation, and restore reconciliation | `weave-mcp-server/src/test/java/com/massimotter/weave/mcp/SpringAiMcpTransportTest.java`, `docs/weave-contract-java-mcp.md` |
