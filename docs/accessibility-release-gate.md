...
| --- | --- | --- |
| member Workspace loop | VoiceOver or TalkBack, desktop keyboard/screen reader, and 200% text scale across Weave Home, channel workspace, chat, files, calendar, boards, meetings, and decisions. | Blocked by #762 successor for #591; do not claim Sprint 18 member workspace accessibility signoff. |
| admin migration apply/recovery | Desktop keyboard, screen reader, and text-scale traversal of dry-run, member-impact preview, apply block, recovery, rollback, and support boundary. | Blocked by #762 successor for #591; do not claim production provider migration apply or lossless cutover. |
| admin go-live claim-control | Desktop keyboard, screen reader, and reflow of release blockers, support-bundle refs, audit/export refs, release notes source, CI/Live Stack evidence, and next actions. | Blocked by #762 successor for #591; missing or stale evidence blocks RC/prod readiness claims. |
| governed Weaver approval/revocation | Desktop keyboard, screen reader, and text-scale traversal of approval, denial, revocation, receipt, audit, and disabled-by-policy states. | Blocked by #762 successor for #591; do not claim broad Weaver availability or autonomous team writes. |
