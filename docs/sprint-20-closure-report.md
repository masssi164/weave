...
| Release evidence at post-closure main head | 12 | 11 | 11 | Current-head GitHub CI + prior candidate live workflow | GitHub CI run `26832803943` passed on `e39c06c`; local `./gradlew ci` and Live Stack E2E run `26829660573` passed on candidate `3b351e8`. |
