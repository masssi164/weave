...
The detailed strategic contracts are [Organization embedding contract](organization-embedding-contract.md), [Identity provisioning strategy](identity-provisioning-strategy.md), [Admin-Suite readiness and setup contract](admin-suite-readiness-setup-contract.md), [Weave Control bootstrap-to-client contract](weave-control-bootstrap-to-client-contract.md), and [Provider replacement and anti-silo contract](provider-replacement-and-anti-silo-contract.md). This page remains the v0.1 first-use boundary for member/admin separation.
