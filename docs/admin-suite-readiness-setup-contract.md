...
Sprint 19 go-live control room extension for #600: the RC claim-control summary must explicitly surface issue #762 as `#762-manual-assistive-technology-signoff-successor-open` while the #591 manual AT gap remains unresolved. That veto blocks public/final release and unsupported accessibility/production-readiness wording, but it must not block Sprint 19 dogfood planning, implementation, or internal control-room evidence work.
