...
Sprint 19 go-live control room extension for #600: the RC claim-control summary must explicitly surface issue #591 as `#591-manual-assistive-technology-signoff-open` while it remains unresolved. That veto blocks public/final release and unsupported accessibility/production-readiness wording, but it must not block Sprint 19 dogfood planning, implementation, or internal control-room evidence work.
