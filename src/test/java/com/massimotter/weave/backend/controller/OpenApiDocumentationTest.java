...
class OpenApiDocumentationTest {
    ...
    void exposesOpenApiDescription() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/profile/readiness']").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/workspaces/{workspaceId}/channels/{channelId}/devops/summary']").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/office/capabilities']").exists())
