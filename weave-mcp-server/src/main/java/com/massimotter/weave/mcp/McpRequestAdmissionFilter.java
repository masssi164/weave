...
final class McpRequestAdmissionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            ExchangedAccessToken exchanged = exchange.exchange(
                    workload,
    ...
    private HttpServletRequest validateExtensionNegotiation(HttpServletRequest request) throws IOException {
        ...
        if ("initialize".equals(root.path("method").stringValue())) {
            JsonNode extension = root.path("params")
                    .path("capabilities")
                    .path("extensions")
