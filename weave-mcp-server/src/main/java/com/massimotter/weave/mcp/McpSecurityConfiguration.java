...
class McpSecurityConfiguration {
    static final String PROTECTED_RESOURCE_METADATA_PATH = "/.well-known/oauth-protected-resource/mcp";
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(
                                ...
                                "/actuator/info",
                                "/error",
                                PROTECTED_RESOURCE_METADATA_PATH).permitAll()
                ...
                .oauth2ResourceServer(oauth2 -> oauth2
                        ...
                        .protectedResourceMetadata(metadata -> metadata
                                .protectedResourceMetadataCustomizer(builder -> builder
                                        ...
                                        .authorizationServers(servers -> {
                                            servers.clear();
                                            servers.add(properties.authorizationServer().toString());
                                        })
                                        .scopes(scopes -> {
                                            scopes.clear();
                        ...
                        .accessDeniedHandler((request, response, failure) -> challenges.forbidden(response)))
    ...
    private static OAuth2TokenValidator<Jwt> exactAudienceValidator(Set<String> expected) {
        return jwt -> {
            ...
            return OAuth2TokenValidatorResult.failure(new OAuth2Error(
                    "invalid_token", "The MCP token audience set is not exact.", null));
        };
    }
}
