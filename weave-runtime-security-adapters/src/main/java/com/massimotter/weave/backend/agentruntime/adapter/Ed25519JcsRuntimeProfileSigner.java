...
public final class Ed25519JcsRuntimeProfileSigner implements RuntimeProfileSigner {
  ...
  public Ed25519JcsRuntimeProfileSigner(
      ObjectMapper objectMapper, RuntimeProfileSigningKeyProvider keys) {
  ...
  public SignedRuntimeProfile sign(RuntimeProfile profile) {
    ...
    try {
      ...
      byte[] signingInput =
          (encodedHeader + "." + encodedPayload).getBytes(StandardCharsets.US_ASCII);
