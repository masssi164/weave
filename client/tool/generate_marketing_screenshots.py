...
SCREENS: tuple[Screen, ...] = (
    Screen(
        ...
        description="A Weave welcome screen invites an admin to configure a dogfood workspace through Weave-owned setup boundaries.",
        active_nav="Setup",
        hero="Set up your Weave workspace",
        subhero="Connect identity, chat, files, and backend services through one guided Weave setup path.",
        metrics=(
        ...
        cards=(
            ...
            ("2", "Service endpoints", "Review support-safe product endpoints before saving the workspace."),
    ...
    Screen(
        ...
        description="The setup review lists support-safe service endpoints before finishing configuration.",
        active_nav="Setup",
        hero="Review Service Endpoints",
        subhero="Weave keeps provider services behind clear product boundaries and explicit readiness states.",
        metrics=(
        ...
        cards=(
            ("✓", "Identity authority", "The configured identity provider owns login, sessions, and user identity claims."),
            ("✓", "Backend facade", "Weave backend is the product API after sign-in."),
            ("✓", "Provider substrate", "Chat and files providers sit behind Weave UX and support-safe contracts."),
        ),
        status="Finish setup",
    ),
    Screen(
        ...
        metrics=(
            ...
            Metric("Encryption", "Guarded evidence scope"),
