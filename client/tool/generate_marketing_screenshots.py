...
SCREENS: tuple[Screen, ...] = (
    Screen(
        ...
        subhero="Connect identity, chat, files, and workspace capabilities through one guided setup path.",
        metrics=(
            Metric("API", "Ready"),
        ...
        cards=(
            ("1", "Workspace sign-in", "Use organization-managed single sign-on without exposing provider setup to members."),
            ("2", "Workspace capabilities", "Review Chat, Files, and Workspace readiness before inviting members."),
    ...
    Screen(
        output_dir=MARKETING_OUTPUT_DIR,
        file_name="02-review-workspace-readiness.svg",
        title="Weave workspace readiness review screen",
        description="The setup review lists product-level workspace readiness before finishing configuration.",
        active_nav="Setup",
        hero="Review Workspace Readiness",
        subhero="Weave keeps implementation services behind clear product boundaries and support-safe setup states.",
        metrics=(
            Metric("Chat", "Ready"),
            Metric("Files", "Ready"),
            Metric("Workspace API", "Ready"),
        ),
        cards=(
            ("✓", "Organization sign-in", "Your organization owns login, sessions, and member identity claims."),
            ("✓", "Workspace API facade", "Weave exposes product capabilities after sign-in."),
            ("✓", "Sovereign workspace modules", "Chat and Files service provide protocol/data foundations behind Weave UX."),
        ),
        status="Finish setup",
    ),
    Screen(
    ...
    Screen(
        ...
        description="The Weave files screen lists folders and files through the workspace Files facade.",
        active_nav="Files",
        hero="/Documents",
        subhero="A basic Weave-owned files UI backed by the product Files capability.",
        metrics=(
            Metric("Connection", "Connected"),
            Metric("Workspace API", "Files facade"),
            Metric("Path", "/Documents"),
        ),
        cards=(
            ("📁", "Plans", "Folder · updated today"),
            ("📄", "spec.pdf", "PDF · Delete action has a label"),
            ("＋", "New folder", "Create folders without visiting raw Files service UI."),
        ),
    ...
    Screen(
        ...
        description="The Weave settings screen shows saved workspace configuration and sign-out controls.",
        active_nav="Settings",
        hero="Workspace Settings",
        subhero="Review workspace configuration, support-safe connection details, and the current session.",
        metrics=(
            Metric("Sign-in status", "Ready"),
            Metric("App", "Configured"),
            Metric("Files", "Ready"),
        ),
        cards=(
            ("⚙", "Workspace configuration", "One persisted setup model shared by onboarding and settings."),
    ...
    Screen(
        ...
        cards=(
            ...
            ("🔐", "Credential readiness", "Workspace API actor credentials are not exposed to generated setup artifacts."),
    ...
    Screen(
        ...
        metrics=(
            ...
            Metric("Control path", "Workspace API token facade"),
