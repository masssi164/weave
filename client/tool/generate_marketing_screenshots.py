...
SCREENS: tuple[Screen, ...] = (
    ...
    Screen(
        ...
        cards=(
            ("M", "Classic calls", "Channel meetings attach to calendar, agenda, tasks, files, and follow-up evidence."),
            ("E", "Encryption gate", "The app does not claim encrypted LiveKit calls until evidence is documented and tested."),
            ("R", "Redacted status", "Status reports booleans only; no server URLs, API keys, secrets, room tokens, or raw provider errors."),
        ),
        status="Guarded roadmap",
    ),
)
