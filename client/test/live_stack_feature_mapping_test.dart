  ...
  test('live stack feature scenarios are mapped to executable E2E evidence', () {
    ...
    expect(
      ...
      unorderedEquals(<String>[
        ...
        'Calendar CalDAV evidence is fail-closed until storage and native sync parity exist',
        'Matrix Chat evidence is fail-closed until Client-Server parity exists',
