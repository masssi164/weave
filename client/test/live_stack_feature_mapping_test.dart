  ...
  test('live stack feature scenarios are mapped to executable E2E evidence', () {
    ...
    expect(
      ...
      unorderedEquals(<String>[
        ...
        'Weaver chat channel roundtrip stays separate from MCP tools',
        'Weaver discovers and invokes Weave MCP tools without a chat message',
        'Weaver keeps channel and MCP planes separate in one same-turn flow',
