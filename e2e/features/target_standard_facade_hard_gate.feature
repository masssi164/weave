Feature: Target standard facade hard gate
  ...
  Scenario: Calendar CalDAV server MVP is separated from native sync parity
    ...
    # Evidence marker: OPENAPI_TRANSITIONAL_DATA_PLANE_DEPRECATED
    ...
    And transitional Calendar REST event routes are deprecated with cleanup tracked by #1044
  ...
  Scenario: Matrix Chat MVP is separated from full protocol and E2EE parity
    ...
    And transitional Chat REST conversation and message routes are deprecated with cleanup tracked by #1044
