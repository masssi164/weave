...
resource "docker_container" "this" {
  ...
  env = concat([
    ...
    "WEAVE_DEVOPS_FORGEJO_RUNTIME_ENABLED=${var.devops_forgejo_runtime_enabled}",
    "WEAVE_DEVOPS_FORGEJO_BASE_URL=${var.devops_forgejo_base_url}",
    "WEAVE_DEVOPS_FORGEJO_API_TOKEN=${var.devops_forgejo_api_token}",
    "WEAVE_DEVOPS_FORGEJO_WRITES_ENABLED=${var.devops_forgejo_writes_enabled}",
