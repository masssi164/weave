...
resource "docker_container" "this" {
  ...
  env = concat([
    ...
    "WEAVE_IDENTITY_KEYCLOAK_BASE_URL=${var.identity_keycloak_base_url}",
    "WEAVE_IDENTITY_KEYCLOAK_REALM=${var.identity_keycloak_realm}",
    "WEAVE_IDENTITY_KEYCLOAK_ORGANIZATION_ALIAS=${var.identity_keycloak_organization_alias}",
    ...
    "WEAVE_OPERATION_INTENTS_STORAGE_MODE=jdbc",
    "WEAVE_PROVIDER_BINDINGS_BOOTSTRAP_FILES_ENABLED=true",
    "WEAVE_PROVIDER_BINDINGS_BOOTSTRAP_FILES_ORGANIZATION_REF=${var.context_authorization_default_tenant_id}",
    "WEAVE_PROVIDER_BINDINGS_BOOTSTRAP_FILES_ADAPTER_KEY=nextcloud-webdav",
    "WEAVE_PROVIDER_BINDINGS_BOOTSTRAP_FILES_CONFIGURATION_REF=secretref:files:nextcloud-dogfood",
