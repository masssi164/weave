...
- `variables.tf`: tenant slug, public URLs, fixed provider-client secrets, administrative-secret rotation epoch, and optional test user flag.
- `outputs.tf`: realm, client, Keycloak-generated administrative credentials, and optional test user outputs returned to the stage root.
