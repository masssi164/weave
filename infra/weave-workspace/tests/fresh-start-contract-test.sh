...
grep -Fq '"retiredGeneration": "legacy-unlabeled-v1"' "${ROOT_DIR}/fresh-start-targets.json"
grep -Fq '"retiredNamespace": "weave"' "${ROOT_DIR}/fresh-start-targets.json"
grep -Fq '"name": "weave-backend"' "${ROOT_DIR}/fresh-start-targets.json"
grep -Fq '"name": "weave_nextcloud_data"' "${ROOT_DIR}/fresh-start-targets.json"
