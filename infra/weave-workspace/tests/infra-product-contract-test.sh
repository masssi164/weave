...
assert_file_contains "${ROOT_DIR}/01-infrastructure/main.tf" 'volume_name    = var.mailpit_volume_name'
...
assert_file_contains "${ROOT_DIR}/teardown.sh" 'weave_mailpit_data'
...
assert_file_contains "${backend_main}" 'WEAVE_CONTEXT_AUTHORIZATION_MEMBERSHIPS_1_PRINCIPAL_REF=${var.context_authorization_dogfood_principal_ref}'
