...
require_script 'recoveryIdentityBoundaryAccepted:true'
require_script 'emptyHumanIdentityBoundary:'
require_script 'bootstrapRetirementRequired:'
require_script 'cat /proc/1/comm'
