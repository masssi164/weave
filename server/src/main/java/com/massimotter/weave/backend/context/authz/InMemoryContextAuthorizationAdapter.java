 ...
 *
 * This adapter is intentionally in-memory and route-free. It establishes the fail-closed policy semantics
 * that later persistence/provider adapters must preserve.
 */
public final class InMemoryContextAuthorizationAdapter implements ContextAuthorizationPort {
    ...
    public InMemoryContextAuthorizationAdapter(
