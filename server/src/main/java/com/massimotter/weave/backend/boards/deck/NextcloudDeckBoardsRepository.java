...
public final class NextcloudDeckBoardsRepository implements BoardsRepository {
    ...
    @Override public TaskItem updateTaskStatus(String taskId, TaskStatus status, String targetColumnId) { throw disabled(); }
    @Override public TaskItem linkDecision(String taskId, String decisionRef) { throw disabled(); }
