...
public final class CanonicalDomainRegistry {
    ...
    public static List<CanonicalDomainRegistryEntryResponse> domains() {
        return List.of(
                ...
                domain("calls", "Calls & Meetings", "MatrixRTC meeting lifecycle, media sessions, participants, recordings, transcripts, captions, consent, retention, and RTC authorization evidence.",
