...
public enum AuditAction {
    ...
    CHAT_EVENT_REDACTED("chat.event.redacted"),
    ...
    MEMBER_INVITATION_CREATED("identity.member_invitation.created"),
    MEMBER_INVITATION_RESENT("identity.member_invitation.resent"),
    MEMBER_INVITATION_REVOKED("identity.member_invitation.revoked"),
    MEMBER_INVITATION_ACCEPTED("identity.member_invitation.accepted"),
    MEMBER_ACCESS_UPDATED("identity.member_access.updated"),
