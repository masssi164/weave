...
@Schema(description = "One support-safe Keycloak platform-security readiness card for Workspace Health/Admin Console.")
public record PlatformIdentityReadinessCardResponse(
        ...
        @Schema(description = "Support-safe operator summary with no Keycloak internals or raw downstream payloads.") String summary,
    ...
    public PlatformIdentityReadinessCardResponse {
