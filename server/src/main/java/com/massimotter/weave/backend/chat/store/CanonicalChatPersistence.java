 ...
 *
 * <p>The domain model deliberately has no JPA annotations. These entities mirror
 * the Flyway-owned schema and expose only aggregate operations needed by the
 * canonical store.
 */
...
class ChatConversationJpaEntity {
    @EmbeddedId
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "conversation_id", nullable = false, length = 160))
    })
...
class ChatMembershipJpaEntity {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "conversation_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part3", column = @Column(name = "identity_issuer", nullable = false, length = 512)),
            @AttributeOverride(name = "part4", column = @Column(name = "actor_ref", nullable = false, length = 255))
    })
    ...
    static ChatMembershipJpaEntity create(
        ...
        entity.updatedAt = CanonicalChatPersistence.utc(
                joinedAt == null ? invitedAt : joinedAt);
        return entity;
    }
...
@Entity
@Table(name = "weave_chat_events")
class ChatEventJpaEntity {
    @EmbeddedId
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "conversation_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part3", column = @Column(name = "event_id", nullable = false, length = 255))
    })
    private ChatTripleId id;

    @Column(name = "sequence_value", nullable = false, insertable = false, updatable = false)
...
class ChatOperationJpaEntity {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "operation_id", nullable = false, length = 96))
    })
    private ChatPairId id;
...
class ChatProviderMappingJpaEntity {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "provider_key", nullable = false, length = 64)),
            @AttributeOverride(name = "part3", column = @Column(name = "object_type", nullable = false, length = 32)),
            @AttributeOverride(name = "part4", column = @Column(name = "canonical_object_id", nullable = false, length = 768))
    })
    private ChatQuadId id;
...
class ChatBridgeLedgerJpaEntity {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "ledger_id", nullable = false, length = 96))
    })
    private ChatPairId id;
...
class ChatAppserviceTransactionJpaEntity {
    @EmbeddedId
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "provider_key", nullable = false, length = 64)),
            @AttributeOverride(name = "part2", column = @Column(name = "homeserver_transaction_id", nullable = false, length = 255))
    })
    private ChatPairId id;
    ...
    static ChatAppserviceTransactionJpaEntity processing(
            ...
            Instant now) {
        ChatAppserviceTransactionJpaEntity entity =
                new ChatAppserviceTransactionJpaEntity();
...
class ChatQuarantineJpaEntity {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "part1", column = @Column(name = "tenant_id", nullable = false, length = 160)),
            @AttributeOverride(name = "part2", column = @Column(name = "quarantine_id", nullable = false, length = 96))
    })
    private ChatPairId id;
    ...
    @Column(name = "private_normalized_event_json", updatable = false)
...
interface ChatMembershipJpaRepository
        extends JpaRepository<ChatMembershipJpaEntity, ChatQuadId> {
...
interface ChatEventJpaRepository
        extends JpaRepository<ChatEventJpaEntity, ChatTripleId> {
    @Query("""
    ...
    Optional<ChatEventJpaEntity> findFirstByIdPart1AndIdPart3(
            String tenantId,
            String eventId);
}

interface ChatOperationJpaRepository
        extends JpaRepository<ChatOperationJpaEntity, ChatPairId> {
    Optional<ChatOperationJpaEntity> findFirstByProviderTransactionId(
            String providerTransactionId);
...
interface ChatOutboxJpaRepository
        extends JpaRepository<ChatOutboxJpaEntity, ChatPairId> {
}
...
interface ChatQuarantineJpaRepository
        extends JpaRepository<ChatQuarantineJpaEntity, ChatPairId> {
    @Query("""
    ...
    Optional<ChatQuarantineJpaEntity> findFirstByIdPart1AndConversationIdAndLifecycleStateInOrderByObservedAtDescIdPart2Desc(
            String tenantId,
            String conversationId,
...
interface ChatChangeJpaRepository
        extends JpaRepository<ChatChangeJpaEntity, Long> {
    @Query("""
