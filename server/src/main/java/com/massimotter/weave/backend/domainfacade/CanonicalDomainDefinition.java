...
public enum CanonicalDomainDefinition {
    FILES_DOCS(
            ...
            List.of("list_drives", "list_folders", "read_file_metadata", "verify_file_checksum", "upload_binary", "delete_item", "request_document_session", "request_guarded_wopi_launch"),
            List.of("provider_native_share_links", "raw_storage_credentials", "editor_launch_without_backend_session"),
            List.of("drive", "folder", "file", "file_version", "blob_ref", "permission", "share_link", "lock", "trash_entry", "checksum", "document", "editor_session", "editor_provider", "coauthoring_state", "version_ref")),
    CALENDAR_MEETINGS(
            "calendar-meetings",
            ...
            List.of("list_calendars", "list_events", "read_event", "create_event", "update_event", "delete_event", "resolve_series_exception", "request_meeting_join", "read_meeting_artifacts"),
            List.of("meeting_recording_control", "provider_native_recurrence_extensions", "external_meeting_admin", "client_side_media_secret"),
            List.of("calendar", "event", "occurrence", "recurrence_rule", "recurrence_exception", "attendee", "resource", "reminder", "time_zone", "conference_link", "meeting", "meeting_room", "participant", "join_grant", "media_session", "recording", "transcript", "caption", "meeting_chat_ref", "consent_record", "retention_policy")),
    BOARDS_TASKS(
            "boards-tasks",
            "Boards and tasks",
            ...
            List.of("list_boards", "list_lists", "list_tasks", "read_status", "create_task", "move_task", "update_task_status", "link_decision", "preview_write", "report_lossy_mapping", "report_conflicts"),
            ...
            List.of("board", "list", "task", "status", "assignee", "watcher", "comment", "attachment_ref", "dependency", "label", "custom_field", "estimate", "priority", "milestone", "sprint", "workflow_rule", "decision_link")),
