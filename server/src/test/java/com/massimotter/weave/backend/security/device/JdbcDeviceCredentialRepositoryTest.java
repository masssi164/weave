...
class JdbcDeviceCredentialRepositoryTest {
    ...
    private JdbcDeviceCredentialRepository repository(DriverManagerDataSource dataSource) {
        return new JdbcDeviceCredentialRepository(
