...
class OpenApiDocumentationTest {
    ...
    void exposesOpenApiDescription() throws Exception {
        MvcResult result = mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/calendar/events'].get.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/calendar/events'].post.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/calendar/events'].get.description")
                        .value(org.hamcrest.Matchers.containsString("/caldav/**")))
                .andExpect(jsonPath("$.paths['/api/calendar/events'].get.description")
                        .value(org.hamcrest.Matchers.containsString("https://github.com/masssi164/weave/issues/1044")))
                ...
                .andExpect(jsonPath("$.paths['/api/calendar/events/{id}'].get.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/calendar/events/{id}'].patch.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/calendar/events/{id}'].delete.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/calls/native-boundary-setup']").exists())
                .andExpect(jsonPath("$.paths['/api/calls/native-boundary-setup'].get.operationId")
                        .value("getCallsNativeBoundarySetup"))
                .andExpect(jsonPath("$.paths['/api/calls/native-boundary-setup'].get.responses['200'].content['*/*'].schema['$ref']")
                        .value("#/components/schemas/CallNativeBoundarySetupResponse"))
                ...
                .andExpect(jsonPath("$.paths['/api/chat/conversations'].get.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/chat/conversations'].get.description")
                        .value(org.hamcrest.Matchers.containsString("/_matrix/client/**")))
                .andExpect(jsonPath("$.paths['/api/chat/conversations'].get.description")
                        .value(org.hamcrest.Matchers.containsString("https://github.com/masssi164/weave/issues/1044")))
                ...
                .andExpect(jsonPath("$.paths['/api/chat/conversations/{conversationId}/messages'].get.deprecated").value(true))
                .andExpect(jsonPath("$.paths['/api/chat/conversations/{conversationId}/messages'].post.deprecated").value(true))
