...
assert_file_contains "${ROOT_DIR}/02-keycloak-setup/modules/tenant-identity/main.tf" 'keycloak_openid_user_attribute_protocol_mapper'
assert_file_contains "${ROOT_DIR}/02-keycloak-setup/modules/tenant-identity/main.tf" 'claim_name          = "weave_tenant_id"'
assert_file_contains "${ROOT_DIR}/02-keycloak-setup/modules/tenant-identity/main.tf" 'weave_tenant_id = var.context_authorization_default_tenant_id'
