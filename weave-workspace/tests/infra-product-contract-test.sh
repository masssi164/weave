...
assert_file_contains "${REPO_DIR}/README.md" 'Matrix voice/video calling or meeting infrastructure (TURN/SFU/Jitsi/LiveKit).'
...
assert_file_contains "${provider_stack_check}" 'matrix-meetings'
