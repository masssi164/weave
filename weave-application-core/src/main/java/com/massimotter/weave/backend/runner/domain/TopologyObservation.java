...
public final class TopologyObservation {
    ...
    public record Entity(
        ...
        public Entity {
            localKey = RunnerControl.bounded(
                    RunnerControl.required(localKey, "localKey"), 512, "localKey");
            kind = RunnerControl.identifier(kind, "entity kind");
            displayName = displayName == null
                    ? null
                    : RunnerControl.bounded(
                            RunnerControl.required(displayName, "displayName"),
                            256,
                            "displayName");
    ...
    public record Relation(
        ...
        public Relation {
            fromLocalKey = RunnerControl.bounded(
                    RunnerControl.required(fromLocalKey, "fromLocalKey"),
                    512,
                    "fromLocalKey");
            predicate = RunnerControl.identifier(predicate, "predicate");
            toLocalKey = RunnerControl.bounded(
                    RunnerControl.required(toLocalKey, "toLocalKey"),
                    512,
                    "toLocalKey");
    ...
    public record Batch(
        ...
        public Batch {
            ...
            detectorVersion = RunnerControl.bounded(
                    RunnerControl.required(detectorVersion, "detectorVersion"),
                    96,
                    "detectorVersion");
            sourceKind = Objects.requireNonNull(sourceKind, "sourceKind");
            scope = scope == null
                    ? null
                    : RunnerControl.bounded(RunnerControl.required(scope, "scope"), 256, "scope");
            ...
            batchDigest = batchDigest == null
                    ? null
                    : RunnerControl.sha256(batchDigest, "batchDigest");
        }
