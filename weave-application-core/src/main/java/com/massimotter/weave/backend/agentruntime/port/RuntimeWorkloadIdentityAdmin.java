...
public interface RuntimeWorkloadIdentityAdmin extends RuntimeWorkloadBindingAuthority {
  ...
  /** Administrative implementations that cannot prove a current binding remain fail-closed. */
  @Override
