...
/**
 * Closed, server-resolved principal used only for exchanged MCP workload calls. The governing
 * member remains an attribution/authorization lookup and is never represented as the OAuth subject.
 */
