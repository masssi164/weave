...
public record RuntimeProfile(
  ...
  public enum PluginRoutingMode {
    ...
    PluginRoutingMode(String wireValue) {
      this.wireValue = wireValue;
    }
  ...
  public enum PersistentTrustPolicy {
    ...
    PersistentTrustPolicy(String wireValue) {
      this.wireValue = wireValue;
    }
  ...
  public record SandboxPolicy(
    ...
    public SandboxPolicy {
      ...
      allowedNetworkTargets =
          allowedNetworkTargets == null
              ? null
              : unique(allowedNetworkTargets, "allowedNetworkTargets", false);
      approvedMountRefs =
          approvedMountRefs == null ? null : unique(approvedMountRefs, "approvedMountRefs", false);
    }
  }
  ...
  public enum SandboxMode {
    ...
    TRUSTED_ADMIN_ONLY("trusted-admin-only");
    private final String wireValue;
  ...
  public enum NetworkPolicy {
    ...
    NetworkPolicy(String wireValue) {
      this.wireValue = wireValue;
    }
  ...
  public enum FilesystemPolicy {
    ...
    FilesystemPolicy(String wireValue) {
      this.wireValue = wireValue;
    }
  ...
  public enum SchedulePolicy {
    ...
    SchedulePolicy(String wireValue) {
      this.wireValue = wireValue;
    }
  ...
  private static void requireHttps(String value, String field) {
    ...
    if (!"https".equalsIgnoreCase(uri.getScheme())
      ...
      throw new IllegalArgumentException(
          field + " must be an HTTPS URI without user info or fragment");
    }
  }
