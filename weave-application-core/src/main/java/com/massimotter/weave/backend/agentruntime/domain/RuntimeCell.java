...
public record RuntimeCell(
  ...
  public RuntimeCell withLease(
      UUID nextLeaseId, Instant expiresAt, long nextFencingEpoch, long nextVersion, Instant now) {
    return new RuntimeCell(
        recordId,
        organizationRef,
        personRef,
  ...
  public RuntimeCell withObservation(
      RuntimeCellState nextObservedState, long nextVersion, String nextAuditRef, Instant now) {
    return new RuntimeCell(
        recordId,
        organizationRef,
        personRef,
